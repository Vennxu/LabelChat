...
public class LimitedAgeDiskCache extends BaseDiskCache {
    ...
    public boolean save(String fileUri, InputStream inputStream, IoUtils.CopyListener listener) throws IOException {
        boolean saved = super.save(fileUri, inputStream, listener);
        rememberUsage(fileUri);
        return saved;
    }

    @Override
    public boolean remove(String fileUri) {
        loadingDates.remove(getFile(fileUri));
        return super.remove(fileUri);
    }
