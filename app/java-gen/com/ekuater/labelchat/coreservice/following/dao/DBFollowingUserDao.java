...
/** 
 * DAO for table DBFOLLOWING_USER.
*/
public class DBFollowingUserDao extends AbstractDao<DBFollowingUser, Long> {

    public static final String TABLENAME = "DBFOLLOWING_USER";

    /**
     * Properties of entity DBFollowingUser.<br/>
    ...
    */
    ...
    public DBFollowingUserDao(DaoConfig config) {
        super(config);
    }
    
    public DBFollowingUserDao(DaoConfig config, DBFollowUserSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'DBFOLLOWING_USER' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'DBFOLLOWING_USER'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DBFollowingUser entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DBFollowingUser readEntity(Cursor cursor, int offset) {
        DBFollowingUser entity = new DBFollowingUser( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DBFollowingUser entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DBFollowingUser entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DBFollowingUser entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
