...
public class LabelImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Path path = new Path();
        path.moveTo(paddingLeft, (paddingTop + vspace) / 2);
        path.lineTo((paddingLeft + hspace) / 5, paddingTop);
        path.lineTo(paddingLeft + hspace, paddingTop);
        path.lineTo(paddingLeft + hspace, paddingTop + vspace);
        path.lineTo((paddingLeft + hspace) / 5, paddingTop + vspace);
        path.moveTo(paddingLeft, (paddingTop + vspace) / 2);
        path.close();
