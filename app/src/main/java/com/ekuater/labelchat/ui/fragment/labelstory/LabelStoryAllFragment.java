...
public class LabelStoryAllFragment extends Fragment {
            ...
            switch (msg.what) {
                ...
                case LABEL_STORY_PRAISE_EXIT:
                    ShowToast.makeText(mContext, R.drawable.emoji_sad,
                            mContext.getResources().getString(R.string.labelstory_input_praise_failed)).show();
                    break;
    ...
    private void onFollowingHandler(Message message){
        switch (message.arg1){
            case ConstantCode.EXECUTE_RESULT_SUCCESS:
                ...
                break;
            default:
                ShowToast.makeText(mContext, R.drawable.emoji_cry, mContext.getResources().getString(R.string.request_failure)).show();
                break;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLabelStoryUtils = new LabelStoryUtils(LabelStoryAllFragment.this, mContentSharer, storyHandler);
        adapter = new LabelStoryAdapter(mContext, mOnClickListener, LabelStoryUtils.ALL);
...
//                    break;
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position != 0) {
                ...
                if (!labelStory.getLabelStoryId().equals("0")) {
                    UILauncher.launchFragmentLabelStoryDetaileActivityUI(LabelStoryAllFragment.this,
                            mLabelStories, position - 1,null, LabelStoryUtils.ALL,DETAIL_RESULT_CODE);
                }
            }
        }
    };
    ...
    public void paramArguments() {
        ...
        if (bundle != null) {
            label = bundle.getParcelable(LABEL);
        }
    ...
    public void getDate() {
        ...
        mLabelStoryManager.accessLabelStoryAllInfo(String.valueOf(indexPager), false, observer);
    }
    ...
    private void onAddLabelResult(int result) {
        ...
        if (success) {
            ShowToast.makeText(mContext, R.drawable.emoji_smile, mContext.getResources().getString(R.string.add_label_success)).show();
        } else {
            ShowToast.makeText(mContext, R.drawable.emoji_cry, mContext.getResources().getString(R.string.add_label_failure)).show();
