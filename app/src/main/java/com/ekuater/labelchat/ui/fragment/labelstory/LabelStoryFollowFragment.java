...
public class LabelStoryFollowFragment extends Fragment {
    ...
    public LabelStoryFollowFragment(){
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLabelStoryUtils = new LabelStoryUtils(LabelStoryFollowFragment.this, mContentSharer, storyHandler);
        adapter = new LabelStoryAdapter(mContext, mOnClickListener, LabelStoryUtils.FOLLOW);
...
//                    break;
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position != 0) {
                ...
                if (!labelStory.getLabelStoryId().equals("0")) {
                    UILauncher.launchFragmentLabelStoryDetaileActivityUI(LabelStoryFollowFragment.this, mLabelStories, position - 1, null,LabelStoryUtils.FOLLOW,DETAIL_RESULT_CODE);
                }
            }
        }
    };
    ...
    public void getDate() {
        ...
        mLabelStoryManager.accessLabelStoryAllInfo(String.valueOf(indexPager), true, observer);
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mLabelStoryNoDateTv.setText(R.string.follow_story_null);
