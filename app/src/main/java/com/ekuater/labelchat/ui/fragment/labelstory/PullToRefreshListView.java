...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void initView(Context context) {
		...
		footer = inflater.inflate(R.layout.labelstory_listview_footer, null);
		loadFull = (TextView) footer.findViewById(R.id.loadFull);
		noData = (TextView) footer.findViewById(R.id.noData);
		more = (TextView) footer.findViewById(R.id.more);
		loading = (ProgressBar) footer.findViewById(R.id.loading);

		header = inflater.inflate(R.layout.labelstory_refresh_header, null);
	...
	public void onRefreshComplete(String updateTime) {
		lastUpdate.setText(this.getContext().getString(R.string.pull_to_refresh_update)+getCurrentTime());
		state = NONE;
...
//			loadFull.setVisibility(View.VISIBLE);
	...
	private void refreshHeaderViewByState() {
		...
		case NONE:
			topPadding(-headerContentHeight);
			tip.setText(R.string.load_full);
		...
		case RELEASE:
			...
			lastUpdate.setVisibility(View.VISIBLE);
			refreshing.setVisibility(View.GONE);
			tip.setText(R.string.pull_to_refresh_refreshing_label);
			tip.setText(R.string.pull_to_refresh_release_label);
			arrow.clearAnimation();
