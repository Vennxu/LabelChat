...
public class AlbumImageView extends ImageView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(getMeasuredWidthAndState(), resolveSizeAndState(getMeasuredWidth(),
                MeasureSpec.getMode(getMeasuredHeightAndState()), 0));
    }
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        final int drawTop = paddingTop + (vspace - hspace) /2;

        final int saveCount = canvas.getSaveCount();
        canvas.save();
       // canvas.clipRect(paddingLeft, paddingLeft, paddingLeft + hspace, paddingLeft + hspace);
        canvas.drawRect(paddingLeft, drawTop, paddingLeft + hspace, drawTop + hspace, mBitmapPaint);
