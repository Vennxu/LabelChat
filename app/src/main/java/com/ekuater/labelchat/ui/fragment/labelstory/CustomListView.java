...
public class CustomListView extends ListView implements OnScrollListener {
    ...
    private View newMessageHintView;
    ...
    private void addHeadView() {
        mHeadView = (LinearLayout) mInflater.inflate(R.layout.labelstory_refresh_header, null);
    ...
    private void addFooterView() {
        mEndRootView = mInflater.inflate(R.layout.labelstory_listview_footer, null);
        mEndRootView.setVisibility(View.VISIBLE);
        mEndLoadProgressBar = (ProgressBar) mEndRootView
                .findViewById(R.id.loading);
        mEndLoadTipsTextView = (TextView) mEndRootView.findViewById(R.id.more);
...
//			endingView.setVisibility(View.VISIBLE);
    ...
    private int mDeltaY;
    private void closeDonwAnimotion() {
    ...
    private void expandDonwAnimotion() {
        AnimationSet animationSet = new AnimationSet(true);
        TranslateAnimation translateAnimation =
                new TranslateAnimation(
                        Animation.RELATIVE_TO_SELF, 0.0f,
            ...
            if(mCanLoadMore && mEndState == ENDINT_LOADING){
                ...
                switch (event.getAction()){
                    ...
                    case MotionEvent.ACTION_MOVE:
                        mDeltaY = (int)event.getY() - mDownPos;
                        invisibleView();
                        break;
...
//                    mDownPos = -1;
    ...
    private void invisibleView() {
        if (mDeltaY < 0) {
            ...
            //mDeltaY < 0 :is slipping from bottom to up
        }else{
